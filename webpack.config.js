...
module.exports = async (env, argv) => {
  ...
  // Remove Expo's HtmlWebpackPlugin / WebpackManifestPlugin to avoid dupes
  ...
  config.resolve = {
    ...
    alias: {
      ...
      // 🔑 Always resolve to the browser shim using an absolute path
  ...
  config.plugins.push(
    ...
    // 🔑 Use absolute paths here so resolution never fails
