    ...
    >
      <View style={styles.modalContainer}>
        <View style={styles.modalContent}>
          <Image
            style={styles.icon}
            source={{ uri: '../assets/images/cofilologo.png' }} // Replace with your actual icon path
          />
          <Text style={styles.title}>Install Application</Text>
          <Text style={styles.text}>Install this application on your home screen for quick and easy access when you&lsquo;re on the go.</Text>
          {iosInstallPrompt && (
            <Text style={styles.instructions}>
              Tap <Image style={styles.shareIcon} source={{ uri: '../assets/images/upload-100.png' }} />  then &ldquo;Add to Home Screen&ldquo;
            </Text>
          )}
          {webInstallPrompt && (
